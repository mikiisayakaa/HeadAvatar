...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("bruteforce_specular_shader_forward2_batch", &bruteforce_specular_shader_forward2_batch, "bruteforce specular shader forward2 batched (CUDA)");
    m.def("bruteforce_specular_shader_backward2_batch", &bruteforce_specular_shader_backward2_batch, "bruteforce specular shader backward2 batched (CUDA)");
    // + shadow
